...
try:
    ...
    folder = r"C:\Studio\Process-Studio\process-studio\ps-workspace\CJ_Maxys_LancamentoCTE\Result"
...
def rename_xlsx(directory: str, new_name: str):
    """
    ...
    matching_files = [f for f in files if fnmatch.fnmatch(f, "TAF1170007SRP*.XLSX")]
...
def ExportarExcel(resultado_do_processamento):
    ...
    rename_xlsx(folder, resultado_do_processamento)
        ...
        for tipo_cte in Tipos_ctes:
            ...
            try:
                ...
                if Mensagem != "Processo finalizado com sucesso.":
                    ...
                    ExportarExcel(resultado_do_processamento)
